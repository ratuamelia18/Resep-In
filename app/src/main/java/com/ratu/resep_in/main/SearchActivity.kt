...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchResultAdapter = RecipeAdapter(
            ...
            onDeleteClick = null,
            onArchiveClick = null,
            onSaveClick = { clickedRecipe ->
                saveRecipeToFavorites(clickedRecipe)
            }
        )
    ...
    private fun saveRecipeToFavorites(recipe: Recipe) {
        ...
        db.collection("favorites").document("${userId}_${recipe.id}")
            .set(favData)
    ...
    private fun toggleFollow(targetUserId: String) {
        ...
        followRef.get().addOnSuccessListener { doc ->
            if (doc.exists()) {
                ...
                targetRef.update("followerCount", FieldValue.increment(-1))
